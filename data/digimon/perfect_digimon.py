...
class PerfectDigimon(DigimonID):
    ...
    METALGREYMON   = DigimonInfo("0x0C", "MetalGreymon",   True, DigimonLevel.ULTIMATE, special=True)
    ...
    H_KABUTERIMON  = DigimonInfo("0x3C", "H-Kabuterimon",  True, DigimonLevel.ULTIMATE, special=True)
    MEGASEADRAMON  = DigimonInfo("0x3D", "MegaSeadramon",  True, DigimonLevel.ULTIMATE, special=True)
